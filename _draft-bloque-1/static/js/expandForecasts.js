...
window.onload = function() {
  chart = initializeChart('evol-fcsts-cpi', evol_gdp_options);
};
      ...
      dataSpaceDiv.innerHTML = `
        <div class="data-space-expanded">
          <div class="title">
            ...
            Evolution of Forecasts <img id="arrow-fig" src="static/icons/arrow-right-square-fill.svg" alt="expand-right" onclick="expandForecasts()">
